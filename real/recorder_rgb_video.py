...
class RecorderRGBVideo(mp.Process):
    ...
    def run(self):
        ...
        while not self.stop_event.is_set():
            ...
            if len(self.topic) > 0:
                ...
                video_path_prefix = '.'.join(video_path[:-1])
                video_path_suffix = video_path[-1]
                video_path = video_path_prefix + "_" + self.topic + "." + video_path_suffix
