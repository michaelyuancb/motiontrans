...
import numpy as np
from real.shared_memory.shared_memory_util import ArraySpec, SharedAtomicCounter
...
class SharedMemoryQueue:
    ...
    def put(self, data: Dict[str, Union[np.ndarray, numbers.Number]]):
        ...
        write_count = self.write_counter.load()
        n_data = write_count - read_count
        # print(f"n_data: {n_data}, buffer_size: {self.buffer_size}, write_count: {write_count}, read_count: {read_count}")
