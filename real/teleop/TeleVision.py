...
class OpenTeleVision:
    def __init__(self, img_shape, shm_name, queue, toggle_streaming, stream_mode="image", distance_to_eye=1.0, cert_file="./cert.pem",
        ...
        while True:
            ...
            session.upsert(
                [ImageBackground(
                    ...
                    height=int(8 / self.distance_to_eye),
                    position=[0, -1, 3],
                    # rotation=[0, 0, 0],
                    layers=1,
                    alphaSrc="./vinette.jpg",
                    # distanceToCamera=int(self.distance_to_eye),
                ),
                    ImageBackground(
                        # Can scale the images down.
                        display_image[::2, self.img_width:],
                        ...
                        # fixed=True,
                        aspect=1.66667,
                        # distanceToCamera=0.5,            # open
                        height=int(8 / self.distance_to_eye),                          # height / 2
                        position=[0, -1, 3],               # z up, figure x, y mean
                        # rotation=[0, 0, 0],
                        layers=2,
                        alphaSrc="./vinette.jpg",
                        # distanceToCamera=int(self.distance_to_eye)
