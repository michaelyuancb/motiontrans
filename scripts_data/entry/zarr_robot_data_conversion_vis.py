...
def conversion_trajectory(input_data_fp_list, hand_to_eef, out_resolutions_resize,
...
def main(input_dir, output, instruction, hand_to_eef_file, 
    ...
    if n_encoding_threads > 1:
        ...
        for i in range(n_encoding_threads):
            ...
            input_data_fp_batch_list[i], hand_to_eef, out_resolution_resize, out_resolution_crop, resolution_image_final,
        ...
        conversion_trajectory(input_data_fp_list, hand_to_eef, out_resolution_resize, out_resolution_crop, resolution_image_final,
