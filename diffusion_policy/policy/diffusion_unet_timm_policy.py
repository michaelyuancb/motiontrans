...
class DiffusionUnetTimmPolicy(BaseImagePolicy):
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor], fixed_action_prefix: torch.Tensor=None, is_human: bool=None) -> Dict[str, torch.Tensor]:
        """
