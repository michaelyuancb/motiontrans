...
from diffusion_policy.policy.diffusion_unet_hra_timm_policy import DiffusionUnetHRATimmPolicy

OmegaConf.register_new_resolver("eval", eval, replace=True)

class TrainDiffusionUnetHRAImageWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionUnetHRATimmPolicy = hydra.utils.instantiate(cfg.policy)
...
def main(cfg):
    workspace = TrainDiffusionUnetHRAImageWorkspace(cfg)
    workspace.run()
